...
def main(args):
  ...
  if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
    ...
    model = modeling[0](k1=1,k2=2,k3=3,embed_dim=256,num_layer=1,device=device).to(device)
...
if __name__ == "__main__":
  ...
  parser.add_argument("--batch_size",type=int,
                      default = 256,
                      help = "Number of drug-tareget per batch. Default is 128 for davis.") # batch 128 for Davis, other 512
